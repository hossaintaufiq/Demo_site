...
export function HomeFooter() {
  ...
  return (
    <div
      ref={containerRef}
      className="relative w-full overflow-hidden bg-gh-page text-gh-black "
    >
      <div
        ref={footerRef}
        className="relative h-full w-full overflow-hidden bg-gh-page  "
      >
        <section
          ref={trailRootRef}
                ...
                <div className="z-[2]  absolute -top-60">
                  ...
                  >
                    ...
                    <path
                      ...
                      fill="black"
                    >
                      {/* SVG: GH Arrow Icon (nested inside logo) */}
                      <svg
                        xmlns="http://www.w3.org/2000/svg"
                        width="100%"
                        viewBox="0 0 31 31"
                ...
                <div className="flex items-center justify-center relative z-[2] -top-20 ">
                  <div className="flex flex-wrap gap-2 text-gh-black ">
                    <a
                      ...
                      target="_blank"
                      rel="noopener noreferrer"
                      className="inline-flex h-13 w-13 items-center justify-center rounded-full bg-gh-off-white hover:opacity-75"
                      aria-label="LinkedIn"
                    >
                      <LinkedInIcon />
                    </a>
