...
export function IntroSection() {
  return (
    <section id="intro-home" className="section_intro bg-gh-page">
      <div className="px-10 py-16 min-[992px]:py-24 max-[479px]:px-5">
        <div className="mx-auto w-full max-w-[120em]">
          <div className="mb-12 min-[992px]:mb-16">
            <h2 className="heading-m max-w-[22ch] text-balance text-gh-black">
          ...
          <div className="grid grid-cols-1 gap-10 min-[992px]:grid-cols-12 min-[992px]:items-end min-[992px]:gap-12">
            <div className="small-image overflow-hidden rounded-[1.5rem] min-[992px]:col-span-3 min-[992px]:max-w-[22rem] min-[992px]:rounded-[2rem]">
            ...
            <div className="content-wrap min-[992px]:col-span-6 min-[992px]:max-w-[42rem] min-[992px]:pb-2">
              <p className="paragraph-l max-w-[30ch] text-gh-black">
