...
(() => {
    ...
    var pt = `${A}-${C}`,
        k = async () => {
            ...
            return !o.includes("webflow.io") || !s.has(pt) ? !1 : (r = t.import) == null ? void 0 : r.call(t, C, "1")
        };
    var R = t => {
        let e = (r, i, n) => {
            let c = t[r],
    ...
    var q = ({
        ...
        mt = () => {
            ...
            let e = At(t);
            B(e, t), Et(e), window.fsAttributes = e, window.FsAttributes = window.fsAttributes, k()
        },
        At = t => {
            let e = {
                cms: {},
                ...
                import (o, s) {
                    ...
                    return r || new Promise(i => {
                        ...
                        n.src = G(o, s), n.async = !0, n.onload = () => {
                            let [c] = B(e, [o]);
                            i(c)
        ...
        Tt = () => {
            let t = w("src", "finsweet", {
                    operator: "contains"
                }),
                e = w("dev");
            return [...document.querySelectorAll(`script${t}, script${e}`)].reduce((r, i) => {
                var c;
                let n = i.getAttribute(x.dev.key) || ((c = i.src.match(/[\w-. ]+(?=(\.js)$)/)) == null ? void 0 : c[0]);
    ...
    var X = () => {
        var t, e;
        return (e = (t = window.fsAttributes).import) == null ? void 0 : e.call(t, $, "1")
    };
    var g = `fs-${m}`,
        ft = "group",
        xt = "accordion",
    ...
    var nt = (t, e) => {
        let o = M(t),
            s = M(e);
        t.setAttribute(J, "button"), t.setAttribute(ot, s), t.setAttribute(tt, "0"), !e.hasAttribute(O) && !e.hasAttribute(et) && e.setAttribute(O, o)
    };
    var D = ({
        accordion: t,
        trigger: e,
        ...
        let u = r ? "add" : "remove";
        t.classList[u](n || i), e.classList[u](l || i), o.classList[u](a || i), s == null || s.classList[u](c || i)
    };
    ...
    var it = t => {
        ...
        Y = t => {
            let e = d(t, "transitionend", ({
                    propertyName: s
                }) => {
                    s === "max-height" && (t.style.display = "none", e())
                }),
                o = P(t);
            return t.style.maxHeight = o, requestAnimationFrame(() => {
    ...
    var ct = t => {
            let e = p(t, "single") === v.true,
                ...
                s = p(t, "active") || z,
                r;
            return o && (f(o, Object.values(h.initial.values)) ? r = o : r = U(o).map(st).filter(N)), {
                single: e,
                initial: r,
                activeClass: s,
                accordions: []
