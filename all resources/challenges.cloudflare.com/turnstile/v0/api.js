            ...
            if (n.source === j) {
                ...
                if (!(!n.widgetId || !g.widgetMap.has(n.widgetId))) {
                    ...
                    if (!(!i || !r)) switch (n.event) {
                        case "init":
                            {
                                var u;r.widgetInitStartTimeTsMs = q(),
                                r.kills = n.kills;
                                var s = r.shadow.getElementById(i);s || v("Cannot initialize Widget, Element not found (#".concat(i, ")."), 3074),
                                r.mode = n.mode,
                                r.nextRcV = n.nextRcV,
                                r.mode === G.Invisible && r.params["refresh-expired"] === re.Manual && b("refresh-expired=manual is impossible in invisible mode, consider using '".concat(re.Auto, "' or '").concat(re.Never, ".'")),
                                r.mode !== G.Managed && r.params["refresh-timeout"] !== fe.Auto && b("setting refresh-timeout has no effect on an invisible/non-interactive widget and will be ignored."),
                                r.params.appearance === Z.Always || r.isExecuting && r.params.appearance === Z.Execute ? Bt(s, r) : Mr(s),
                                s.style.display = "";
                        ...
                        case "translationInit":
                            {
                                ...
                                var T = new Map;r.displayLanguage = n.displayLanguage,
                                r.displayRtl = n.displayRtl,
                                Object.keys(n.translationData).forEach(function(Q) {
                        ...
                        case "requestFeedbackData":
                            {
                                var Ie, Y = r.shadow.querySelector("#".concat(i));Y || v("Received state for an unknown widget: #".concat(i, " / ").concat(n.widgetId), 3078),
                                (Ie = Y.contentWindow) === null || Ie === void 0 || Ie.postMessage({
                        ...
                        case "turnstileResults":
                            {
                                var oe, ce, ge = (oe = r.wrapper.parentNode) === null || oe === void 0 ? void 0 : oe.querySelector("#".concat(i, "-fr"));ge || v("Received state for an unknown widget: ".concat(n.widgetId), 3078),
                                (ce = ge.contentWindow) === null || ce === void 0 || ce.postMessage({
                                    cfChlOut: r.cfChlOut,
                        ...
                        case "closeFeedbackReportIframe":
                            {
                                var le, Oe = (le = r.wrapper.parentNode) === null || le === void 0 ? void 0 : le.querySelector("#".concat(i, "-fr"));Oe || v("Received state for an unknown widget: ".concat(n.widgetId), 3078),
                                wr("".concat(i, "-fr"));
                                break
                            }
                        case "tokenExpired":
                            {
                                var ue, Ce = n.token;r.isExpired = !0,
                                (ue = r.cbExpired) === null || ue === void 0 || ue.call(r, Ce),
                                r.params["refresh-expired"] === re.Auto && !r.isResetting && w(X.AutoExpire, i);
                                break
                            }
                        ...
                        case "reloadRequest":
                            {
                                l(r, n.nextRcV, n.widgetId),
                                w(n.trigger, i);
                                break
                            }
                        case "interactiveBegin":
                            {
                                var Me, Be = r.shadow.getElementById(i);Be || v("Cannot layout widget, Element not found (#".concat(i, ")."), 3076),
                                (Me = r.cbBeforeInteractive) === null || Me === void 0 || Me.call(r),
                        ...
                        case "requestExtraParams":
                            {
                                var K;r.widgetParamsStartTimeTsMs = q();
                                var Le = r.shadow.querySelector("#".concat(i));Le || v("Received state for an unknown widget: ".concat(n.widgetId), 3078),
                                r.isResetting = !1;
                                var Fe = {},
                                    se = q(),
                                    Pe = {
                                ...
                                (K = Le.contentWindow) === null || K === void 0 || K.postMessage(qe({
                                    action: r.action,
